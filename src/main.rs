...
use config::{AudioFormat, Cli, Config, DEFAULT_FOLDER, RIPRIP_PATH};
...
async fn print_release_table(releases: &[Release], _config: &Config) -> anyhow::Result<()> {
